...
for days in dict.keys(schedule):
#loop through the schedule to find the keys
	print(days)
	#print the keys value (monday-friday)

	#Sort the rooms for the day and loop through them and print the room number.
	for room_nums in schedule[days]:
	#loop through the days to find room numbers
		print(room_nums)

		#Then loop through each class and print it out.
		for course in schedule[days][room_nums]:
		#loop through the room numbers to get the courses
			print(course['class'])
